<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="TeamEdit.aspx.cs" Inherits="DemoWebApp.TeamEdit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="row">
        <%
            ...
            scon.Open();
            var scmd = new SqlCommand("select TeamName from Teams where TeamId= '" + id + "';", scon);
            ...
            scmd = new SqlCommand("select 'Y' IsActive from Teams where TeamId = '" + id + "' and EnabledFlag=1 ", scon);
        ...
        <div class="box box-<% if(isActive == "Y") { %>success<% } else { %>danger<% } %>">
            ...
            <div class="box-header">
                <div style="float: right; margin-right: 1%;">
                    <asp:Button ID="BackBtn" class="btn btn-block btn-primary" runat="server" Text="<%$Resources:Global, BackButton%>" OnClick="BackButton_OnClick" />
                </div>
            </div>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="teamName" name ="teamName" value="<%=teamName%>" <% if(isActive != "Y") { %> readonly="readonly" <% } %>/>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        <asp:DropDownList ID="ManagerDDL" class="form-control" runat="server" Width="100%" Height="33px"/>
                    </div>
                </div>
                  ...
                  <div class="row">
                      <%
                          if (isActive == "Y")
                          {
                              %>
                          <div class="col-sm-6">
                              <asp:Button class=" btn btn-success fa fa-envelope  btn-block" ID="UpdateBtn" runat="server" Text="<%$ Resources:Global, UserEdit_input %>" OnClick="btnUpdate_Click"  />
                          </div>
                          <div class="col-sm-6">
                              <asp:Button class=" btn-block btn btn-danger fa fa-envelope" ID="DisableBtn" runat="server" Text="<%$ Resources:Global, Add_tbl_h5 %>" OnClick="btnDelete_Click" />
                          </div>
                              <%
                          }
                          else
                          {
                             %>
                          <div class="col-sm-12">
                              <asp:Button class=" btn btn-success fa fa-envelope  btn-block" ID="ActiveBtn" runat="server" Text="<%$ Resources:Global, UserActivate %>" OnClick="btnActive_Click"  />
                          </div>
                             <%
                          }
                      %>
