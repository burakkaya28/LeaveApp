<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="LeaveTypeManagement.aspx.cs" Inherits="DemoWebApp.LeaveTypeManagement" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <%=Global.Menu_LeaveTypeManagement %>
</asp:Content>
             ...
             <div class="box">
                <div class="box-header">
                    ...
                    <div style="float: right; margin-right: 1%;">
                        <asp:Button ID="AddLeaveType" class="btn btn-block btn-primary" runat="server" Text="<%$Resources:Global,AddLeaveType%>" OnClick="AddLeaveType_Click" />
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.LeaveType%></th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.LeaveTypeTR %></th>
                                    ...
                                    <tbody>
                                        <%
                                            try
                                            {
                                                ...
                                                var scmd = new SqlCommand("Select LeaveTypeId, LeaveType, LeaveTypeTr, EnabledFlag from LeaveTypes", scon);
                                                var sreader = scmd.ExecuteReader();
                                                while (sreader.Read())
                                                {
                                                    var leaveTypeId = sreader["LeaveTypeId"].ToString();
                                                    var leaveType = sreader["LeaveType"].ToString();
                                                    var leaveTypeTr = sreader["LeaveTypeTr"].ToString();
                                                    var enabledFlag = sreader["EnabledFlag"].ToString();
                                            %>
                                            <tr>
                                                <td><a href="EditLeaveType?id=<%=leaveTypeId%>"><%=leaveType%></a></td>
                                                <td><%=leaveTypeTr%></td>
                                                <td><% 
