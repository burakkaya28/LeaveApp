<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="TeamManagement.aspx.cs" Inherits="DemoWebApp.TeamManagement" EnableEventValidation="false" %>
             ...
             <div class="box">
                <div class="box-header">
                    ...
                    <div style="float: right;" class="exportPC">
                        <asp:Button class="btn btn-block btn-primary" ID="ExportBtn" runat="server" Text="<%$ Resources:Global, ExportToExcelText %>" OnClick="Export_Click" />
                    </div>
                    
                    <div style="float: right; margin-right: 1%;">
                        <asp:Button ID="AddTeam" class="btn btn-block btn-primary" runat="server" Text="<%$Resources:Global,AddTeam%>" OnClick="AddTeam_Click" />
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.TeamNameText %></th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.ManagerText%></th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="descending"><%=Global.StatusText%></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <%
                                            try
                                            {
                                                ...
                                                var scmd = new SqlCommand("select t.TeamId, t.TeamName, m.FullName Manager, t.EnabledFlag from Teams t join Users m on m.UserId = t.ManagerId", scon);
                                                var sreader = scmd.ExecuteReader();
                                                while (sreader.Read())
                                                {
                                                    var teamId = sreader["TeamId"].ToString();
                                                    var teamName = sreader["TeamName"].ToString();
                                                    var manager = sreader["Manager"].ToString();
                                                    var enabledFlag = Convert.ToBoolean(sreader["EnabledFlag"]);
                                            %>
                                            <tr>
                                                <td><a href="EditTeam?id=<%=teamId%>"><%=teamName%></a></td>
                                                <td><%=manager%></td>
                                                <td><% 
                                                    if (enabledFlag)
                                                    {
                ...
                <!-- EXPORT TO EXCEL -->
                 ...
                 <div class="box-body" id="ExportTableTeam" runat="server" style="display: none;">
