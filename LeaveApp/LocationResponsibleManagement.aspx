<%@ Page Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="LocationResponsibleManagement.aspx.cs" Inherits="DemoWebApp.SysLocationResponsibles" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <%=Global.Menu_LocationResponsibles %>
</asp:Content>
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div style="float: right;" class="exportPC">
                        <asp:Button class="btn btn-block btn-primary" ID="ExportButton" runat="server" Text="<%$ Resources:Global, ExportToExcelText %>" OnClick="ExportButton_Click" />
                    </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.ResponsibleLocation%></th>
                                    ...
                                    <tbody>
                                        <%
                                            try
                                            {
                                                ...
                                                var scmd = new SqlCommand("select u.UserId, u.FullName, u.Role, m.FullName Manager, u.EnabledFlag, l.LocationName, l.LocationNameTR, l.LocationIcon from Users u join LocationResponsibles lr on lr.UserId = u.UserId join Users m on m.UserId = u.ManagerId join Locations l on l.LocationId = lr.LocationId order by u.FullName asc", scon);
                ...
                <!-- EXPORT TO EXCEL -->
                 ...
                 <div class="box-body" id="exportTable" runat="server" style="display: none;">
                    ...
                    <div id="table_export_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">

                        <div class="row">
                            <div class="col-sm-12">
                                <div class="box-body table-responsive no-padding">
                                <table id="table-export" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.Default_approvals_table_th2%></th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.UserEdit_input2%></th>
