<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="SysAdmins.aspx.cs" Inherits="DemoWebApp.SysAdmins" EnableEventValidation="false" %>
                                    ...
                                    <tbody>
                                        <%
                                            try
                                            {
                                                ...
                                                var scmd = new SqlCommand("select u.UserId, u.FullName, u.Role, m.FullName Manager, u.EnabledFlag, l.LocationName, l.LocationNameTR, l.LocationIcon from Users u join Admins a on a.UserId = u.UserId join Users m on m.UserId = u.ManagerId join Locations l on l.LocationId = u.LocationId order by u.FullName asc", scon);
