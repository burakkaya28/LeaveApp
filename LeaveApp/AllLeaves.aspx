<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="AllLeaves.aspx.cs" Inherits="DemoWebApp.AllRequest" %>
    ...
    <div class="box">
        <div class="box-header">
            ...
            <div style="float: right;" class="exportMobile">
                <asp:Button class="btn btn-block btn-primary" ID="ExportMobile" runat="server" Text="<%$ Resources:Global, ExportToExcelText %>" OnClick="ExportMobile_Click" />
            </div>
        </div>
                    ...
                    <div class="col-sm-12">
                       <div class="box-body table-responsive no-padding">
                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            <thead>
                                <tr role="row">
                                    <th class="sorting"><%=Global.Default_approvals_table_th1%></th>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">           <%=Global.Request_lbl1%>
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" >
                            ...
                            <tbody>
                                <%
                                    try
                                    {
                                        ...
                                        scon.Open();
                                        var scmd = new SqlCommand(new ReportSqlQueries().AllLeavesSql, scon);
