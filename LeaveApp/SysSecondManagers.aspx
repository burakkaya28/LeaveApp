<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="SysSecondManagers.aspx.cs" Inherits="DemoWebApp.SysSecondManagers" EnableEventValidation="false" %>
    ...
    <div class="box top80" runat="server">
        <div class="box-body chart-responsive">
             <div class="box">
                ...
                <div class="box-body" id="tablebody3" runat="server">
                                    ...
                                    <tbody>
                                        <%
                                            try
                                            {
                                                ...
                                                var scmd = new SqlCommand("select u.UserId, u.FullName, u.Role, m.FullName Manager, u.EnabledFlag, l.LocationName, l.LocationNameTR, l.LocationIcon from Users u join SecondManagers sm on sm.UserId = u.UserId join Users m on m.UserId = u.ManagerId join Locations l on l.LocationId = u.LocationId order by u.FullName asc", scon);
