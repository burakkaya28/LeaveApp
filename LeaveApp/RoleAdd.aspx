<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="RoleAdd.aspx.cs" Inherits="DemoWebApp.RoleAdd" EnableEventValidation="false" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <center> <asp:Label ID="Label2" runat="server" Text="" ForeColor ="Red"></asp:Label></center>
                <div class="box-body">
                ...
                <!-- Back Buton -->
                <div class="form-group has-feedback" style="margin-left:2%; margin-right:2%;">
                    <asp:Button ID="BackButton" runat="server" Text="<%$Resources:Global,BackButton%>" Width="100%" class="btn btn-primary" OnClick="BackButton_OnClicktton" />
                </div>
                <br />
            </div>
        </div>
