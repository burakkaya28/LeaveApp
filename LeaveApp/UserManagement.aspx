<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="UserManagement.aspx.cs" Inherits="DemoWebApp.UserManagement" EnableEventValidation="false" %>
             ...
             <div class="box">
                <div class="box-header">
                    ...
                    <div style="float: right; margin-right: 1%;">
                        <asp:Button ID="AddUser" class="btn btn-block btn-primary" runat="server" Text="<%$Resources:Global,AddUser%>" OnClick="AddUser_Click" />
                    </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting_desc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="descending"><%=Global.UserStartDate%></th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.ManagerText%></th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.SecondManagerText%></th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"><%=Global.Team%></th>
                                    ...
                                    <tbody>
                                        <%
                                            try
                                            {
                                                ...
                                                var scmd = new SqlCommand("select u.UserId, u.FullName, u.Role, u.StartDate, m.FullName Manager, sm.FullName SecondManager, u.EnabledFlag, t.TeamName, l.LocationName, l.LocationNameTR, l.LocationIcon from Users u join Users m on m.UserId = u.ManagerId left join Users sm on sm.UserId = u.SecondManager left join Locations l on l.LocationId = u.LocationId left join Teams t on t.TeamId = u.TeamId order by 1 asc", scon);
                                                var sreader = scmd.ExecuteReader();
                                                while (sreader.Read())
                                                {
                                                    var startDate = "";
                                                    var rId = sreader["UserId"].ToString();
                                        ...
                                        if (sreader["StartDate"] != null && sreader["StartDate"].ToString() != "")
                                        {
                                            startDate = Convert.ToDateTime(sreader["StartDate"]).ToString("dd-MM-yyyy");
                                                    ...
                                                    var secondManagerName = sreader["SecondManager"].ToString();
                                            ...
                                            %>
                                            <tr>
                                                <td><a href="EditUser?id=<%=rId%>"><%=userFullName%></a></td>
                                                <td><%=role%></td>
                                                <td><%=startDate%></td>
                                                <td><%=managerName%> </td>
                                                <td><%=secondManagerName%> </td>
                                                <td><%=teamName %></td>
                                                <td>
