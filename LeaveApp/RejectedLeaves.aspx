<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="RejectedLeaves.aspx.cs" Inherits="DemoWebApp.RejectedRequests" %>
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            ...
                            <%
                                try
                                {
                                    ...
                                    scon.Open();
                                    var scmd = new SqlCommand(new ReportSqlQueries().RejectedLeaveSql, scon);
